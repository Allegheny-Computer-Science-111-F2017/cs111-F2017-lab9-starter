...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labnine/ \
                                     --checkfiles TodoListManager.java --multicomments 2 --language Java
  determine_exit_code $?
  # --> GatorGrader CHECK: the "new" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labnine \
                                     --checkfiles TodoListManager.java --fragments "= new" --fragmentcounts 2
  determine_exit_code $?
  # --> GatorGrader CHECK: the "while (" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labnine \
                                     --checkfiles TodoListManager.java --fragments "while (" --fragmentcounts 3
  determine_exit_code $?
  # --> GatorGrader CHECK: the "if (" fragment does exist in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labnine \
                                     --checkfiles TodoListManager.java --fragments "if (" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK: the "println (" fragment does exist in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labnine \
                                     --checkfiles TodoListManager.java --fragments "println(" --fragmentcounts 9
  determine_exit_code $?
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labnine \
                                     --checkfiles TodoListManager.java --fragments "break;" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK: the "Iterator" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labnine \
                                     --checkfiles TodoListManager.java --fragments "Iterator<TodoListItem>" --fragmentcounts 2
  determine_exit_code $?
  # --> GatorGrader CHECK: the correct number of comments in the Java code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labnine/ \
                                     --checkfiles TodoListItem.java --multicomments 9 --language Java
  determine_exit_code $?
  # --> GatorGrader CHECK: the "private" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labnine \
                                     --checkfiles TodoListItem.java --fragments "private" --fragmentcounts 6
  determine_exit_code $?
  # --> GatorGrader CHECK: the correct number of comments in the Java code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labnine/ \
                                     --checkfiles TodoList.java --multicomments 9 --language Java
  determine_exit_code $?
  # --> GatorGrader CHECK: the "private" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labnine \
                                     --checkfiles TodoList.java --fragments "private" --fragmentcounts 2
  determine_exit_code $?
  # --> GatorGrader CHECK: the "while (" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labnine \
                                     --checkfiles TodoList.java --fragments "while (" --fragmentcounts 5
  determine_exit_code $?
  # --> GatorGrader CHECK: the "if (" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labnine \
                                     --checkfiles TodoList.java --fragments "if (" --fragmentcounts 4
  determine_exit_code $?
